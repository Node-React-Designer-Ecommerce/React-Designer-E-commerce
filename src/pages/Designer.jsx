...
//     if (isEditMode && savedCanvas) {
//       loadFromJSON(fabricCanvas.current, savedCanvas);
//     }

//     if (editDesignId) {
//       loadSavedDesign(editDesignId);
//     }
...
//       const formData = new FormData();
//       formData.append("designId", editDesignId);
//       formData.append("canvas", JSON.stringify(canvasJSON));
//       formData.append("image", imageOfDesign);
//       formData.append("totalPrice", totalPrice.toString());
...
//       const updateResponse = await updateCanvasToBackend(formData);
//       toast.success("Your Design updated successfully");
//       console.log("Canvas updated successfully:", updateResponse);
//     } catch (error) {
