...
export default function CartPage() {
  ...
  const totalQuantity = Array.isArray(data)
    ? data.reduce((sum, product) => sum + product.quantity, 0)
    : 0;
  const totalPrice = Array.isArray(data)
    ? data.reduce((sum, product) => sum + product.price * product.quantity, 0)
    : 0;
        ...
        <div className="mb-5">
          <div className="grid grid-cols-1 lg:grid-cols-3  gap-5">
            <div className="col-span-2 grid grid-rows p-5">
              <h1 className="mb-5 font-bold text-3xl text-black ">
                Shopping Cart
              </h1>
              ...
              <div>
                ...
                {Array.isArray(data) &&
                  data.map((product) => (
                    <div
                      key={product._id}
                      className="card card-side bg-base-100 shadow-xl w-full h-auto lg:h-60 mt-5 mb-5 rounded-none"
                    >
                      <figure>
                        <img
                      ...
                      <div className="card-body grid grid-cols-1 lg:grid-cols-3 mt-5">
                        ...
                        <div className="col-span-2 flex flex-col lg:flex-row justify-between items-center lg:justify-around ">
                          <div className="flex items-center space-x-2 mb-2 lg:mb-0   ">
                            ...
                            <p className="mt-2 mx-2 fs-2">conter</p>
                            <button className="btn btn-outline-secondary total-btn">
                              {" "}
                              +1
                            </button>
                          ...
                          <div className="text-center lg:text-left">total</div>
                        </div>
                      </div>
                    </div>
                  ))}
